...
const AuthPage = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch('https://roofings-server.vercel.app/api/user/login', {
                method: 'POST',
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const response = await fetch('https://roofings-server.vercel.app/api/user/register', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
